...
"""
Django settings for messy-proj project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'u=i#5%k1-5)iiu!@7u3ux#h9of^j9d6+-x^r-d%mc4dh__da1x')
...
MATERIAL_ADMIN_SITE = 'messy.admin.admin_site'
...
# See .ebextensions/messy-proj.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'messy-proj.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
